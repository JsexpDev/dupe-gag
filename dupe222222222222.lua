...
local function DupeTool()
    ...
    char:WaitForChild("Humanoid") -- upewniamy się, że Character jest w pełni gotowy
    local backpack = player:WaitForChild("Backpack")

    -- Czekamy aż narzędzie pojawi się w ręce (maks. 5s)
    local tool
    local t0 = tick()
    repeat
...
CreateMessage("Hey! Hello to Script Hub Dupe!", function()
    task.wait(0.2)
    -- Drugi komunikat + automatyczne kopiowanie
