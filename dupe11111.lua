...
frame.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- ciemne tło (VSCode dark)
...
label.Font = Enum.Font.Code -- VSCode styl kodu
...
mainMenu.BackgroundColor3 = Color3.fromRGB(20,20,25) -- ciemny panel
...
-- === Reszta mechaniki (nie zmieniona) ===
local function Dupe()
