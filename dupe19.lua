...
local function Dupe()
    ...
    -- Klonowanie do lokalnego ekwipunku
    local clone = item:Clone()
    clone.Name = item.Name.."_VisualCopy"
    clone.Parent = eqFolder

    -- Jeżeli model, ustaw PrimaryPart i zakotwiczenie
...
local function OpenDupeMenu()
    ...
    frame2.Size = UDim2.new(0,400,0,200)
    ...
    lagBtn.Size = UDim2.new(0.4,0,0.2,0)
    ...
    dupeBtn.Size = UDim2.new(0.4,0,0.2,0)
    ...
    killBtn.Position = UDim2.new(0.05,0,0.35,0)
